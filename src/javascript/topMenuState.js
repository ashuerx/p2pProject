$(function () {
    $.get('api/checkState.php', function (result) {
        ...
        if (result.isSuccess) {
            htmlStr = `
           <li>
                <a href="#"><span class="glyphicon glyphicon-user"></span>${result.username}</a>
                </li>
                <li>
                <a href="#"><span class="glyphicon glyphicon-yen"></span>赶快充值</a>
                </li>
                <li>
                <a href="../../api/loginOut.php"><span class="glyphicon glyphicon-log-out"></span>注销</a>
            </li>
